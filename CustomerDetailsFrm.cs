...
{
    public partial class CustomerDetailsFrm : Form
    {
        private Controller controller;

        public CustomerDetailsFrm()
        {
            InitializeComponent();
        }
        ...
        private void CustomerDetailsFrm_Load(object sender, EventArgs e)
        {
            //Set window text to customer 'ID - Name
        }
    }
